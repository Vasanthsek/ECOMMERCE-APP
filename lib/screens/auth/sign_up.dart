  ...
  void _submitForm() async{
    ...
    if (isValid) {
      ...
      if (_pickedImage == null) {
          _globalMethods.authDialog('Please pick an image', context);
        } else {
          setState(() {
            _isLoading = true;
          });
      ...
      await  _auth.createUserWithEmailAndPassword(email: _emailAddress.toString().toLowerCase().trim(), password: _password.toString().toLowerCase().trim());
      final User? user = _auth.currentUser;
          ...
          Navigator.canPop(context) ? Navigator.pop(context) : null;} //we can use .then
