                ...
                children: [
                  ...
                  Flexible(
                    child: dialogContent(context, 1, () {
                      Navigator.pushNamed(context, ProductDetails.routeName, arguments:prodAttr.id ).then((value) => Navigator.canPop(context) ? Navigator.pop(context) : null);
                    }),
                  ),
                  Flexible(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: const Padding(
                  ...
                  child:  FaIcon(
                                  FontAwesomeIcons.xmark, size: 28, color: Colors.white),
                ),
              ),
            ),
          ),
